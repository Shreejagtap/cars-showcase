...
const darkMode = () => {
    ...
    if (mode.classList.contains("dark")) {
        ...
        document.getElementById("dark-button").innerHTML = `<i class="fa-solid fa-moon"></i>`
        ...
        document.getElementById("dark-button").innerHTML = `<i class="fa-solid fa-sun"></i>`
        document.getElementById("hero-container").innerHTML = `<img
...
const mobNav = () => {
    ...
    if (nav.classList.contains("open")) {
        ...
        document.getElementById("hamburgerico").innerHTML = `<i class="fa-solid fa-bars"></i>`
    }
    else {
        nav.classList.add("open")
        document.getElementById("hamburgerico").innerHTML = `<i class="fa-solid fa-xmark"></i>`
    }
